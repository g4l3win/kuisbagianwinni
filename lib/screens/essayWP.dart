...
class WPIsian extends StatefulWidget {
  @override
  _IsianState createState() => _IsianState();
}

class _IsianState extends State<WPIsian> {
  int score = 0;
  int timeLeft = 20;
  Timer? timer;
  double nilai = 0;
  ...
  final Map<int, String> correctAnswers = {
    1: 'HTML', // jawaban benar pertanyaan 1
    2: 'echo', // jawaban benar untuk kedua
    3: ';', // jawaban benar untuk ketiga
  };
          ...
          child: Column(
            ...
            children: [
              ...
              if (currentQuestion == 1) ...[
                buildQuestion(
                  'Pertanyaan 1 dari 3',
                  'Apa singkatan dari HyperText Markup Language?',
                ),
              ] else if (currentQuestion == 2) ...[
                buildQuestion(
                  'Pertanyaan 2 dari 3',
                  'Fungsi untuk menampilkan output di PHP adalah ___()?',
                ),
