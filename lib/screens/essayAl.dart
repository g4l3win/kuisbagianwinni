...
class AlIsian extends StatefulWidget {
  @override
  _IsianState createState() => _IsianState();
}

class _IsianState extends State<AlIsian> {
  int score = 0;
  int timeLeft = 20;
  Timer? timer;
  double nilai = 0;
  ...
  final Map<int, String> correctAnswers = {
    1: 'stack', // jawaban benar pertanyaan 1
    2: 'boolean', // jawaban benar untuk kedua
    3: 'loop', // jawaban benar untuk ketiga
  };
