...
class DSQuizHomePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => DSPilihanganda()),
                  );
                },
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => DSBenarsalah()),
                  );
                },
                style: ElevatedButton.styleFrom(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => DSIsian()),
                  );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xFF3B547A), // background button warna
      ...
      appBar: AppBar(
        title: Text("SQL Quiz",
            style: TextStyle(color: Colors.white)), // Judul halaman
        leading: IconButton(
